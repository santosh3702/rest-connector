...
/**
 * A simple wrapper around Spring's RestTemplate to allow for easy creation with
 * V4's instrumentation. This is available for edge-case needs. You should use
 * {@link RestClientFactory} to get your client if at all possible.
 * 
 * Use of this class does not guarantee the availability of timeout
 * functionality.
 */
@Component
